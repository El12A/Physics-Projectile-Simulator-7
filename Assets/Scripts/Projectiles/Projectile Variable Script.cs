...
public class ProjectileVariableScript : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        projectile1.AddComponent<MeshFilter>();
        projectile1.AddComponent<MeshRenderer>();
        projectile1.GetComponent<MeshRenderer>().material = basicMaterial;
        UpdateProjectile();
    ...
    private void UpdateProjectile()
    {
        ...
        projectile1.transform.transform.localScale = Vector3.one;
    ...
    public void OnShapeDropdownChange()
    {
        ...
        UpdateProjectile();
        projectile1.transform.localScale = Vector3.one;
    }
