...
public class CalculateButton : VariableControllerInput
{
    ...
    private Vector3 SetVariableVector3(Vector3 variable, int index)
    {
        ...
        // this is the x coordinate i am timsing it by -1 to flip the direction so that positive x value will now flip direction so projectile goes away from cannon instead of towards it
